...
=======
    ...
    #API endpoints
    path('v1/list_user/', views.List_User, name="list_user"),
    path('v1/list_usuario/', views.List_Usuario, name="list_usuario"),
    path('v1/list_materia_actual/', views.List_Materia_Actual, name="list_materia_actual"),
    path('v1/list_escuela/', views.List_Escuela, name="list_escuela"),
    path('v1/list_grupo/', views.List_Grupo, name="list_grupo"),
    path('v1/list_periodo/', views.List_Periodo, name="list_periodo"),
